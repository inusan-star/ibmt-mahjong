...
class IBMTIntent(nn.Module):
    """
    Intent-Belief Multi-task Transformer for Intent Prediction
    """
    ...
    def __init__(
        ...
        # IBMT_intent: Intent head for yaku prediction
